 ...
 */
public class SimpleAdapterClone extends BaseAdapter implements Filterable {
    private int[] mTo;
     ...
     */
    public SimpleAdapterClone(Context context, List<? extends Map<String, ?>> data,
    ...
    private void bindView(int position, View view) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v != null) {
                ...
                if (from[i] == "fecha") {
                    int fechaX = Integer.parseInt(text.replace("/", "").substring(4, 8).concat(text.replace("/", "").substring(2, 4)).concat(text.replace("/", "").substring(0, 2)));

                    mod = fechaX % 2;
                    view.setBackgroundColor((mod == 0 ? Color.argb(150, 149, 255, 149): Color.argb(150,196, 196, 255)));
                }
    ...
    public void setViewImage(ImageView v, String value) {
        try {
            ...
            new DownloadTask(v).execute(value);
        }
    }
